...
![A blue coloured transformer resembling Optimus Prime.](./cover.jpg)
...
![Model architecture for Transformers](./model-architecture.png)
...
![Input/ Output Embedding and Positional Encoding layers](./embedding-position-encoding.png)
...
![Scaled Dot-Product Attention](./scaled-dot-product.png)
...
![Feed Forward Network](./feed-forward-network.png)
...
![Residual Connections and Normalization](./residual-connections.png)
...
![Masking in the Self-Attention Block of the Decoder](./masking-self-attention.png)
